...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private final String MONTH_ENGLISH[] = {"Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aout", "Septembre", "Octobre", "Novembre", "Decembre"};
    ...
    private void initComponents() {
        ...
        cmdForward = new app.component.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new app.component.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new app.component.datechooser.Button();
        cmdPrevious = new app.component.datechooser.Button();
        slide = new app.component.datechooser.Slider();

        header.setBackground(new java.awt.Color(204, 93, 93));

        cmdForward.setIcon(new javax.swing.ImageIcon("D:\\Projet L3\\DesktopAppVenteMaterielInformatique\\src\\app\\images\\forward.png")); // NOI18N
        ...
        cmdMonth.setText("Janvier");
        cmdMonth.setFont(new java.awt.Font("Leelawadee", 0, 16)); // NOI18N
        cmdMonth.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        cmdYear.setFont(new java.awt.Font("Leelawadee", 0, 16)); // NOI18N
        cmdYear.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon("D:\\Projet L3\\DesktopAppVenteMaterielInformatique\\src\\app\\images\\previous.png")); // NOI18N
        ...
        headerLayout.setHorizontalGroup(
            ...
            .addGroup(headerLayout.createSequentialGroup()
                ...
                .addGap(2, 2, 2)
                .addComponent(MY, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(slide, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0))
        );
    ...
    private app.component.datechooser.Button cmdForward;
    private app.component.datechooser.Button cmdMonth;
    private app.component.datechooser.Button cmdPrevious;
    private app.component.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private app.component.datechooser.Slider slide;
