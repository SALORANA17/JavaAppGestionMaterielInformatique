package app.component.titleBarWindow;
...
public class SimpleButtonBar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdClose = new app.component.titleBarWindow.Buttont();
        cmdResize = new app.component.titleBarWindow.Buttont();
        cmdMinimize = new app.component.titleBarWindow.Buttont();
    ...
    private app.component.titleBarWindow.Buttont cmdClose;
    private app.component.titleBarWindow.Buttont cmdMinimize;
    private app.component.titleBarWindow.Buttont cmdResize;
